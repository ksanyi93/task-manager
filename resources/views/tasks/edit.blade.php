                ...
                @endif
                    <form method="POST" action="{{ route('tasks.update', $task) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('schedule_date') is-invalid @enderror" id="schedule_date" name="schedule_date" value="{{ old('schedule_date', $task->schedule_date->format('Y-m-d')) }}" required>
